...
\section{Future work}
% Add what you were going to add, I just wanted to put one more thing here
...
\bibitem[\protect\citename{Johnson et. al}2007]
H. Johnson, J. Martin, G. Foster and R. Kuhn.
\newblock 2007.
\newblock {\em In Proceedings of the 2007 Joint Conference on Empirical Methods in Natural Language Processing and Computational Natural Language Learning (EMNLP-CoNLL), pp. 967-975}.
